...
Match.new(round: 1, 
	      ...
	      score_team_A_set_1: nil,
	      score_team_B_set_1: nil,
	      score_team_A_set_2: nil,
	      score_team_B_set_2: nil, 
	      score_team_A_set_3: nil, 
	      score_team_B_set_3: nil, 
	      score_team_A_set_4: nil, 
	      score_team_B_set_4: nil, 
	      score_team_A_set_5: nil, 
	      score_team_B_set_5: nil, 
	      user_id: 1).save
